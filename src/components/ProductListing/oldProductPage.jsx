                            ...
                            <div className="w-full lg:w-2/5 lg:sticky top-16 lg:h-screen">
                                ...
                                <div className="flex flex-col gap-3 m-3 ">
                                    <div className="w-full lg:w-[450px] h-full pb-6 border relative">
                                        ...
                                        <div
                                            className={`absolute top-4 right-4 shadow-lg bg-white w-9 h-9 border flex items-center justify-center rounded-full ${isAdmin ? "hidden" : ""
                                                } `}
                                        >
                                            <span
                                        ...
                                        {/* Share button */}
                                        <div className="absolute top-16 right-4 shadow-lg bg-white w-9 h-9 border flex items-center justify-center rounded-full">
                                            <span
                                                onClick={handleShareProduct}
                                                className="text-primaryBlue hover:text-blue-600 cursor-pointer"
                                    ...
                                    <div className="w-full flex gap-3">
                                        ...
                                        <button
                                            ...
                                            className={`disabled:cursor-not-allowed flex items-center justify-center gap-2 text-white rounded-sm shadow hover:shadow-lg p-4 ${product.stock < 1
