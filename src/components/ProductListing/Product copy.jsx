        ...
        <>
            ...
            <div className="relative p-1">
                ...
                <span
                    ...
                    className="absolute z-10 top-2 right-10 cursor-pointer text-blue-500 hover:text-blue-700 bg-white rounded-full w-7 h-7 flex items-center justify-center shadow"
                    title="Share this product"
                >
                    <ShareIcon sx={{ fontSize: "18px" }} />
                </span>
                {/* <!-- share badge --> */}
                <div className="flex flex-col items-center gap-2 w-full px-4 py-6 shadow relative hover:shadow-lg rounded-sm">
                    {/* <!-- image & product title --> */}
                    <Link
                        to={`/product/${_id}`}
